<?php HeaderDashboard(); ?>
<?php SidebarDashboard(); ?>
<div id="contenido" class="mt-2 active" style="height: 100%; min-height:300px; ">
            ...
            <div class="card-header">
                <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1 ps-2">
                        ...
                        <li class="breadcrumb-item text-primary active" aria-current="page">Overview</li>
                    </ol>
                </nav>
            </div>
            <div class="card-body">
                ...
                <button class="btn btn-sm btn-light border-1 border-secondary" id="btnSpinner">
